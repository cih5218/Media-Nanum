...
.profile-left-top>div>a>img{width: 100px; min-height:100px; padding: 2px; border: 1px solid #e5e5e5; background-color: #fff;}
                              ...
                              <div class="margin-20 shadow-box">
                                   <a href="board_detail.nn?board_no=${profile.board_no}">
                                       ...
                                       <div class="category-img">
                                           ...
                                           <img src="${pageContext.request.contextPath}/resources/images/${profile.board_image_title}" alt="">
                                       </div>
                                   </a>
                                       ...
                                       <div class="margin-15 position-relative">
                                               ...
                                               <div class="position-relative">
                                                   ...
                                                   <div class="category-profile-img">
                                                       <img src="${pageContext.request.contextPath}/resources/images/plus.jpg" alt="">
                                                   </div>
                                               </div>
                                           </div>
                                           <h6 class="category-id">
                                               <a href="#" class="color-8">${member[0].member_name}
                                               </a>
                                           </h6>
