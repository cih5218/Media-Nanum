...
<head>
    ...
    <script src="${pageContext.request.contextPath}/resources/js/board_modify.js"></script>
            	...
            	<form id="multiform" action="board_modifyOk.nn?board_no=${boardnn.board_no}" method="post" enctype="multipart/form-data">
                    	...
                    	<div class="shadow-box new-body">
                        	<div id="" class="new-section">
                            	<div class="row">
                                    ...
                                    <div class="col-right">
                                    	<div>
                                        	<input name="board_title" id="real_board_title" type="text" class="form-control" value="${boardnn.board_title}">
                                        </div>
                                        <h6 class="margin-10">
                                        	<div>최소&nbsp;10&nbsp;글자</div>
                                        </h6>
                    	...
                    	<div class="shadow-box new-body">
                            	...
                            	<div class="row">
                                    ...
                                    <div class="col-right">
                                    	...
                                    	<div class="margin-10">
                                            ...
                                            <input type="hidden" name="board_image_title" id="image_board_title" value="${boardnn.board_image_title}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            	...
                            	<div class="row">
                                    ...
                                    <div class="col-right">
										...
										<div class="margin-10">
                                            ...
                                            <input type="hidden" name="board_image_detail" id="image_board_detail" value="${boardnn.board_image_detail}">
                                        </div>
									</div>
                                </div>
                            </div>
                            <div id="" class="new-section">
                            	<div class="row">
                                    ...
                                    <div class="col-right">
                                    	<div>
                                        	<input name="board_movie_url" id="real_board_movie_url" type="text" class="form-control" value="${boardnn.board_movie_url}">
                                        </div>
                                        <h6 class="margin-10">
                                        	<div>최소&nbsp;10&nbsp;글자</div>
                                        </h6>
                            ...
                            <div id="">
                            	<div class="row">
                                    ...
                                    <div class="col-right">
                                    	<div>
                                        	<textarea name="board_content" id="board_content" class="form-control" rows="10" style="margin: 0px -4px 0px 0px; width: 550px;">${boardnn.board_content}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                	...
                	<div class="board-panel board-write3">
                                    ...
                                    <div class="col-right">
                                    	...
                                    	<div class="margin-10">
                                            <div class="inline-block">
                                            	<input name="tag_name" id="tag_name" type="text" class="form-control" placeholder="#나눔" maxlength="50" value="<c:choose><c:when test="${taginfo.size()!=0}"><c:forEach items="${taginfo}" var="i">#${i.tag_name}</c:forEach></c:when><c:otherwise></c:otherwise></c:choose>">
                            	...
                            	<div class="row">
                                    ...
                                    <div class="col-right">
                                    	...
                                    	<div class="margin-10">
                                            ...
                                            <div class="inline-block">
                                            	<input id="real_board_account" type="text" class="form-control">
                                            	<input type="hidden" id="board_account_split" name="board_account" value="${boardnn.board_account}">
                                            	<script type="text/javascript">
                                            		var str = $('#board_account_split').val().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
                                            		$('#real_board_account').val(str);
                                            	</script>
                                            </div>
                                        </div>
                                        <h6 class="margin-10">
                                        ...
                                        <div class="margin-10">
                                            <div class="inline-block">
                                            	<input type="text" id="nanumdatepicker" name="board_term" class="form-control" readonly="readonly" value="${boardnn.board_term}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div>
                        	<div class="board-write-btn">
                            	<div class="margin-30 new-list-btn">
                                	<input type="submit" class="btn btn-primary btn-block" id="check_onclick" value="나눔수정">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="file_detail" id="file_detail">
                    </form>
                </div>
            </div>
            <!-- section -->
