            	...
            	<form id="multiform" action="board_writeOk.nn" method="post" enctype="multipart/form-data">
                    	...
                    	<div class="shadow-box new-body">
                        	<div id="" class="new-section">
                            	<div class="row">
                                    ...
                                    <div class="col-right">
                                    	<div>
                                        	<input name="board_title" type="text" class="form-control" placeholder="예) 마음을 담아 재미있고 개성있는 캐리커쳐를 그려 드립니다">
                                        </div>
                                        <h6 class="margin-10">
                                        	<div>최소&nbsp;10&nbsp;글자</div>
                                        </h6>
                	...
                	<div class="board-panel board-write2">
                    	<div class="shadow-box new-body">
                            ...
                            <div id="" class="new-section">
                            	<div class="row">
                                    ...
                                    <div class="col-right">
                                    	<div>
                                        	<input name="board_movie_url" type="text" class="form-control" placeholder="예) 마음을 담아 재미있고 개성있는 캐리커쳐를 그려 드립니다">
                                        </div>
                                        <h6 class="margin-10">
                                        	<div>최소&nbsp;10&nbsp;글자</div>
                                        </h6>
                            ...
                            <div id="">
                            	<div class="row">
                                    ...
                                    <div class="col-right">
                                    	<div>
                                        	<textarea name="board_content" class="form-control" rows="10" style="margin: 0px -4px 0px 0px; width: 550px;" placeholder="재능의 대한 설명을 작성해주세요."></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                        	<div class="board-write-btn">
                            	<div class="margin-30 new-list-btn">
                                	<input type="submit" class="btn btn-primary btn-block" value="나눔등록">
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-right">
                                    	...
                                    	<div class="margin-10">
                                            ...
                                            <div class="inline-block">
                                            	<input name="board_account" type="number" class="form-control" placeholder="5,000">
                                            </div>
                                        </div>
                                        <h6 class="margin-10">
                                        ...
                                        <div class="margin-10">
                                            <div class="inline-block">
                                            	<input type="number" name="board_term" class="form-control" placeholder="1">
                                            </div>
